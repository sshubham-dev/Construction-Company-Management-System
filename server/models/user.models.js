...
const userSchema = new mongoose.Schema({
    ...
    department: {
        type: String,
        enum: ['Admin', 'Company', 'Client', 'Supplier', 'Contractor', 'Accountant', 'Marketing', 'Ceo', 'Site Incharge', 'Site Supervisor', 'Design Head', 'Design Engineer', 'Quality Head', 'Quality Engineer'],
        default: null,
    },
    avatar: {
        type:String,

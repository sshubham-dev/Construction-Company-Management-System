...
const { createStock, getStockById, getStocks, updateStock, deleteStock, createStockGroup, getStockGroupById, getStockGroups, updateStockGroup, deleteStockGroup } = require('../controller/stock.controller');

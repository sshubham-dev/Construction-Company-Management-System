...
const ProfileCard = () => {
  return (
    <div className="flex flex-row justify-center max-w-md p-6 shadow-lg rounded-xl sm:px-12 bg-white">
	...
	<div className="space-y-4 text-center divide-y ">
		...
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md  hover:text-violet-600">
			...
			<a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md text-gray-800 dark:text-violet-600">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">

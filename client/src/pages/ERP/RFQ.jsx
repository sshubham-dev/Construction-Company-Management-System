...
//                 <div>
//                   <h2 className="font-semibold text-lg">{rfq.rfqNo}</h2>
//                   <p className="text-sm text-gray-500 mt-1">
...
//                 <InfoCard title="Store" value={rfq.storeId?.name} />

//                 <InfoCard title="Items" value={rfq.items?.length} />

//                 <InfoCard title="Suppliers" value={rfq.suppliers?.length} />

//                 <InfoCard
//                   title="Date"
//                   value={moment(rfq.date).format("DD MMM YYYY")}
//                 />
//               </div>

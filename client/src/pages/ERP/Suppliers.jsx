    ...
    <div>
      <section className="overflow-x-auto">
            ...
            <tbody className="divide-y divide-gray-200">
              {filtered?.map((supplier) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">{supplier.gstNo}</td>
        ...
        <Modal
          ...
          isOpen={createModal}
          head="Create Supplier"
        >
          <CreateSupplier onClose={() => setCreateModal(false)} />
        </Modal>
        <Modal
          onClose={() => setEditModal(false)}
          isOpen={editModal}
          head="Update Supplier"
        >
          <CreateSupplier onClose={() => setEditModal(false)} isEdit={editId} />
        </Modal>

  ...
  return (
    <div>
      <div className="overflow-x-auto">
        ...
        <div className="w-full mx-auto mb-4 text-gray-700 p-1 flex flex-row justify-between items-center">
          ...
          <button
            ...
            className="bg-green-500 rounded-full text-white px-2 py-2 sm:mt-0"
          >
            ...
            <tbody className="divide-y divide-gray-200">
              {filtered?.map((employee, index) => (
                <tr key={index} className="bg-white border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">{employee?.whatsapp}</td>
